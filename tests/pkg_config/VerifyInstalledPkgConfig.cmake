...
foreach(_installed_file IN LISTS _installed_files)
  ...
  if(_installed_file MATCHES "/f2c\\.pc$")
    message(FATAL_ERROR
      "The install manifest unexpectedly contains the unsupported f2c.pc alias")
  endif()
endforeach()
...
assert_pc_contains("prefix=${EXPECTED_PC_PREFIX}")
assert_pc_contains("libdir=${EXPECTED_PC_LIBDIR}")
assert_pc_contains("includedir=${EXPECTED_PC_INCLUDEDIR}")
