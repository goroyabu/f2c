...
if(TEST_CASE STREQUAL "local_valid_libf2c")
  set(_archive_name "libf2c.zip")
else()
  set(_archive_name "src.tgz")
endif()
...
if(TEST_CASE STREQUAL "local_valid_src" OR
   TEST_CASE STREQUAL "local_valid_libf2c")
...
elseif(TEST_CASE STREQUAL "download_failure_allowed")
  ...
  set(_allow_unverified ON)
  set(_expect_success OFF)
  set(_expected_failure_text "Failed to download upstream archive")
else()
...
if(_expect_success)
  ...
  if(_expect_mismatch_details)
    foreach(_expected_text
        ...
        "${_expected_sha}"
        "${_bad_sha}"
        "F2C_ALLOW_UNVERIFIED_ARCHIVES=ON"
        "not suitable for CI or release builds")
