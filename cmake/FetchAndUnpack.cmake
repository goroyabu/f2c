...
function(fetch_and_unpack_configure_dirs)
  if(F2C_ALLOW_UNVERIFIED_ARCHIVES)
    message(WARNING
      "F2C_ALLOW_UNVERIFIED_ARCHIVES=ON permits SHA256-mismatched upstream "
      "archives. This mode is not suitable for CI or release builds.")
  endif()
...
function(verify_input_file FILE_PATH EXPECTED_SHA)
  ...
  if(NOT _actual_sha STREQUAL _expected_sha)
    ...
    if(F2C_ALLOW_UNVERIFIED_ARCHIVES)
      message(WARNING
        "${_mismatch_message}\n"
        "Proceeding because F2C_ALLOW_UNVERIFIED_ARCHIVES=ON. "
        "This mode is not suitable for CI or release builds.")
    else()
