...
**Report a vulnerability** on the repository's Security page. Include enough
...
- the installed `f2c` converter and `libf2c` runtime as packaged here; and
- repository-specific changes to upstream sources or generated artifacts.

Reports involving downloaded upstream f2c or libf2c code are welcome for
